...
import 'package:hotel_ma/feature/presentation/screens/event_screen.dart';
        ...
        GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onTap: () => Navigator.of(context).push(createRouteAnimFromBottom(EventScreen(eventModel: event!))),
                child: Column(
