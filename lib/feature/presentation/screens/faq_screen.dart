    ...
    return Scaffold(
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            data['imageRoot'] == null ? Container() : Stack(children: [
              Image.network(
                data['imageRoot']!,
                fit: BoxFit.cover,
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  /// faq_date
                  Text(data['date'], style: Theme.of(context).textTheme.bodyText1!.copyWith(fontWeight: FontWeight.w500, color: kMainGreyColor),),
                  /// faq_nave
                  Text(data['title'], style: Theme.of(context).textTheme.headline3!.copyWith(fontWeight: FontWeight.w500,),),
